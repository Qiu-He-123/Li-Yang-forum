...
const routes = [
  ...
  },
  {
    path: '/orders',
    name: 'order-hall',
    component: () => import('../views/orders/OrderHall.vue'),
    // 大厅公开可浏览（未登录也能看任务），发布/接单/钱包等操作仍需登录
    meta: { keepAlive: true, skeleton: true },
  },
  {
    path: '/orders/publish',
    name: 'order-publish',
    component: () => import('../views/orders/OrderPublish.vue'),
  ...
  },
  {
    path: '/orders/wallet',
    name: 'order-wallet',
    component: () => import('../views/orders/OrderWallet.vue'),
    meta: { requiresAuth: true },
  },
  {
    path: '/orders/lottery',
    name: 'order-lottery',
    component: () => import('../views/orders/Lottery.vue'),
    meta: { requiresAuth: true },
  },
  {
    path: '/orders/:id',
  ...
  },
  {
    path: '/pet-backpack',
    name: 'pet-backpack',
    component: () => import('../views/PetBackpack.vue'),
    meta: { requiresAuth: true },
  },
  {
  ...
  },
  {
    path: '/pet-play',
    name: 'pet-play',
    component: () => import('../views/PetPlay.vue'),
    meta: { requiresAuth: true },
  },
  {
    path: '/pet-chat/:petId',
  ...
  },
  {
    ...
    component: () => import('../views/GratitudeDetail.vue'),
  },
  {
    path: '/publish/gathering',
    name: 'publish-gathering',
    component: () => import('../views/PublishGatheringView.vue'),
    meta: { requiresAuth: true },
  },
  {
    path: '/gatherings',
    name: 'gatherings',
    component: () => import('../views/GatheringsView.vue'),
  },
  {
    path: '/gatherings/:id',
    name: 'gathering-detail',
    component: () => import('../views/GatheringDetailView.vue'),
  },
  {
    path: '/user/:id',
    name: 'user-home',
  ...
  },
  {
    path: '/wechat',
    name: 'wechat-sync',
    component: () => import('../views/WeChatSyncView.vue'),
    meta: { requiresAuth: true },
  },
  {
    path: '/wechat/bind',
    name: 'wechat-bind',
    component: () => import('../views/BindWechatView.vue'),
    meta: { requiresAuth: true },
  },
  {
    path: '/wechat/publish',
    name: 'wechat-publish',
    component: () => import('../views/PublishChoiceView.vue'),
    meta: { requiresAuth: true },
  },
  {
    path: '/wechat/publish/sync',
    name: 'wechat-publish-sync',
    component: () => import('../views/SyncPublishView.vue'),
    meta: { requiresAuth: true },
  },
  {
    path: '/wechat/publish/manual',
    name: 'wechat-publish-manual',
    component: () => import('../views/ManualPublishView.vue'),
    meta: { requiresAuth: true },
  },
  {
    path: '/publish',
    name: 'publish-hub',
    component: () => import('../views/PublishHubView.vue'),
    meta: { requiresAuth: true },
  },
  {
    path: '/video/share',
    name: 'video-share',
    component: () => import('../views/ShareVideoView.vue'),
    meta: { requiresAuth: true },
  },
  {
    path: '/coins',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'pet-ai',
        name: 'admin-pet-ai',
        component: () => import('../views/Admin/PetAiManage.vue'),
      },
      {
        path: 'explore',
        name: 'admin-explore',
      ...
      {
        path: 'wechat-manage',
        name: 'admin-wechat-manage',
        component: () => import('../views/Admin/WechatManage.vue'),
      },
      {
      ...
      {
        path: 'assistant-logs',
        name: 'admin-assistant-logs',
        component: () => import('../views/Admin/AiLogs.vue'),
      },
      {
        path: 'guess',
        name: 'admin-guess',
        component: () => import('../views/Admin/GuessManage.vue'),
      },
      {
        path: 'pet-shop',
        name: 'admin-pet-shop',
        component: () => import('../views/Admin/PetShopManage.vue'),
      },
      {
        path: 'gratitude',
        name: 'admin-gratitude',
        component: () => import('../views/Admin/GratitudeManage.vue'),
      },
      {
        path: 'games',
        name: 'admin-games',
      ...
      {
        path: 'orders',
        name: 'admin-order-tasks',
        component: () => import('../views/Admin/OrderTasks.vue'),
      },
      {
        path: 'orders/recharges',
        name: 'admin-order-recharges',
        component: () => import('../views/Admin/OrderRecharges.vue'),
      },
      {
        path: 'orders/withdraws',
        name: 'admin-order-withdraws',
        component: () => import('../views/Admin/OrderWithdraws.vue'),
      },
      {
        path: 'orders/settings',
        name: 'admin-order-settings',
        component: () => import('../views/Admin/OrderSettings.vue'),
      },
      {
        path: 'orders/ai',
        name: 'admin-order-ai',
        component: () => import('../views/Admin/OrderAiManage.vue'),
      },
      {
        path: 'orders/lottery',
        name: 'admin-order-lottery',
        component: () => import('../views/Admin/LotteryManage.vue'),
      },
    ],
  },
  // 404 兜底
...
router.beforeEach(async (to) => {
  ...
  // 封号用户强制跳转到封号提示页（除非已在封号页/退出登录流程/后台管理页）
  // —— 被封号的管理员仍能登录 /admin 管理后台（去封号管理、申诉管理等处解封别人/自己），
  //    所以 /admin* 路由不受普通用户封号状态约束。
  if (
    to.name !== 'banned' &&
