...
<template>
  <main class="page-activities">
    ...
    <!-- 常驻置顶：赚金币入口（永远在第一个） -->
    <button type="button" class="act-coins-entry" @click="goEarnCoins">
      <span class="act-coins-entry__icon">
        <Icon name="coin" :size="26" color="#fff" />
      </span>
      <span class="act-coins-entry__body">
        <span class="act-coins-entry__title">赚金币</span>
        <span class="act-coins-entry__desc">每日任务 · 签到 · 玩小游戏，金币拿到手软</span>
      </span>
      <span class="act-coins-entry__go">去赚金币 →</span>
    </button>
...
.act-coins-entry:active {
  transform: scale(0.98);
}
.act-coins-entry__icon {
  flex: none;
  width: 44px;
  height: 44px;
  display: grid;
...
.act-coins-entry__title {
  font-size: 16px;
  font-weight: 800;
  letter-spacing: 1px;
}
.act-coins-entry__desc {
  font-size: 12px;
