...
const visitCards = computed(() => {
  ...
  return [
    ...
    },
    {
      key: 'appUnique',
      label: '手机端独立 IP',
      value: v.app_unique_ips,
      today: v.app_today_unique_ips,
      todayLabel: '今日',
      icon: '📲',
      color: '#fa8c16',
      bg: '#fff7e6',
    },
    {
      key: 'downloads',
      label: '手机端下载数',
      value: stats.value.downloads.total,
      today: stats.value.downloads.today,
      todayLabel: '今日',
      icon: '⬇️',
      color: '#52c41a',
      bg: '#f6ffed',
    },
    {
      key: 'downloadIps',
      label: '下载独立 IP',
      value: stats.value.downloads.unique_ips,
      today: 0,
      todayLabel: '',
      icon: '📦',
      color: '#13c2c2',
