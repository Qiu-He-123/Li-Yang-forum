...
class ErrorCode:
    ...
    # ============ 求助帖 ============
    HELP_REWARD_REQUIRED = -216      # 求助帖必须填写悬赏金币
    POST_ALREADY_SOLVED = -217       # 求助帖已解决，无法重复标记
    COMMENT_NOT_BEST = -218          # 该评论不属于本求助帖，不能选为最佳回复
...
_ERROR_MESSAGES: dict[int, str] = {
    ...
    ErrorCode.HELP_REWARD_REQUIRED: "求助帖必须填写悬赏金币",
    ErrorCode.POST_ALREADY_SOLVED: "该求助帖已解决，无法重复标记",
    ErrorCode.COMMENT_NOT_BEST: "该评论不属于本求助帖，不能选为最佳回复",
