...
- 种子数据：内置 4 款宠物小游戏 + 6 款 tufang HTML 小游戏
"""
...
def _seed_games(bind) -> None:
    ...
    games = [
        ...
        ("记忆翻牌", "memory", "single", "翻出所有配对的图案，考验记忆力！", "🧠", 5, 5, 1),
        ("猜拳", "rps", "single", "和宠物石头剪刀布，三局两胜！", "✊", 5, 5, 2),
        ("幸运轮", "wheel", "single", "转一转，赢好感大礼包！", "🎡", 5, 5, 3),
        ("打地鼠", "mole", "single", "小地鼠冒头啦，快敲它脑袋！", "🐹", 5, 5, 4),
